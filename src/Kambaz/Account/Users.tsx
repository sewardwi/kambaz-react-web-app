...
export default function Users() {
  ...
  const applyFilters = async (nameFilter: string, roleFilter: string) => {
  ...
  const filterUsersByName = async (name: string) => {
    ...
    // new code to filter by name and role
    setName(name);
    await applyFilters(name, role);
  };
  ...
  const filterUsersByRole = async (role: string) => {
    ...
    //   fetchUsers();
    // }
    // console.log(name); // just for to get rid of the eslint warning
